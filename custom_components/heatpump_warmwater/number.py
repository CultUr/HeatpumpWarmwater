...
_NUMBERS: list[WwNumberDescription] = [
    ...
    WwNumberDescription(
        key=KEY_MIN_TODAY_KWH,
        name="Min Tages-PV-Forecast (kWh)",
        ...
        mode=NumberMode.BOX,
        default=DEFAULT_MIN_FORECAST_TODAY_KWH,
        coord_attr="min_forecast_today_kwh",
        entity_category=EntityCategory.CONFIG,
    ),
    WwNumberDescription(
        key=KEY_MIN_TOMORROW_KWH,
        name="Aufschub wenn morgen besser (kWh)",
        ...
        native_unit_of_measurement="kWh",
        mode=NumberMode.BOX,
        default=DEFAULT_MIN_FORECAST_TOMORROW_KWH,
        coord_attr="min_forecast_tomorrow_kwh",
        entity_category=EntityCategory.CONFIG,
    ),
    WwNumberDescription(
        key=KEY_MIN_GRID_SURPLUS,
        name="Min Netz-Einspeisung Reaktiv-Start (W)",
        ...
        native_unit_of_measurement="W",
        mode=NumberMode.BOX,
        default=DEFAULT_MIN_GRID_SURPLUS_W,
        coord_attr="min_grid_surplus_w",
        entity_category=EntityCategory.CONFIG,
    ),
    WwNumberDescription(
        key=KEY_MIN_SOC_GRID,
        name="Min Akku-SoC bei Reaktiv-Start (%)",
